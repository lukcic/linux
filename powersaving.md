...
Rettot into BIOS and make sure that all options that have ASPM are Enabled (not default).

Install powertop. In the `Idle stats` tab check state of c-states. If C3 works it's ok, if not, some of the PCI devices may does not support ASPM or has it disabled.
...
01:00.0: Enabled ASPM L1
02:00.0: Enabled ASPM L1
02:04.0: Enabled ASPM L1
02:08.0: Enabled ASPM L1
02:0c.0: Already has ASPM L1 enabled
08:00.0: Enabled ASPM L1
e1:00.0: Enabled ASPM L1
e2:00.0: Enabled ASPM L1
```
...
<https://www.youtube.com/watch?v=qyGbkEtjJ90&list=WL&index=69>
